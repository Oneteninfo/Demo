<template>
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <ul class="navbar-nav">
        <!-- <li><router-link tag= "div" to="/" class="nav-link">Home</router-link></li> -->
        <!-- <li><router-link :to="routerLink" class="nav-link">Home</router-link></li> -->
        <li><router-link to="/" class="nav-link">Home</router-link></li>
        <li><router-link to="menu" class="nav-link">Menu</router-link></li>
        <li><router-link to="admin" class="nav-link">Manage</router-link></li>
